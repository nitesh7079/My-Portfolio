            ...
            <div className="mt-10 flex flex-wrap gap-4 relative z-10">
              {socialLinks.map(({ label, href, className, style, icon }) => (
                <a
                  ...
                  className={`w-14 h-14 rounded-2xl border border-[var(--border-color)] flex items-center justify-center hover:-translate-y-1 transition-all shadow-lg focus:outline-none focus:ring-2 focus:ring-[var(--accent-primary)] ${className}`}
                  style={style}
